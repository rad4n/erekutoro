...
-- Dumping structure for table erekutoro.album
...
-- Dumping data for table erekutoro.album: ~2 rows (approximately)
DELETE FROM `album`;
...
-- Dumping structure for table erekutoro.category
...
-- Dumping data for table erekutoro.category: 4 rows
...
-- Dumping structure for table erekutoro.comment
...
-- Dumping data for table erekutoro.comment: ~3 rows (approximately)
DELETE FROM `comment`;
...
-- Dumping structure for table erekutoro.component
...
-- Dumping data for table erekutoro.component: ~3 rows (approximately)
...
-- Dumping structure for table erekutoro.contact
...
-- Dumping data for table erekutoro.contact: ~0 rows (approximately)
DELETE FROM `contact`;
/*!40000 ALTER TABLE `contact` DISABLE KEYS */;
/*!40000 ALTER TABLE `contact` ENABLE KEYS */;


-- Dumping structure for table erekutoro.gallery
...
-- Dumping data for table erekutoro.gallery: ~6 rows (approximately)
DELETE FROM `gallery`;
...
-- Dumping structure for table erekutoro.media
...
-- Dumping data for table erekutoro.media: ~0 rows (approximately)
DELETE FROM `media`;
/*!40000 ALTER TABLE `media` DISABLE KEYS */;
INSERT INTO `media` (`id_media`, `file_name`, `file_type`, `file_size`, `date`) VALUES
	(2, 'ebook-gratis--arduino-untuk-pemula-v1-103182-popoji.pdf', 'application/pdf', '3307633', '2015-12-20');
/*!40000 ALTER TABLE `media` ENABLE KEYS */;


-- Dumping structure for table erekutoro.menu
...
-- Dumping data for table erekutoro.menu: 15 rows
DELETE FROM `menu`;
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
INSERT INTO `menu` (`id`, `parent_id`, `title`, `url`, `class`, `position`, `group_id`) VALUES
	(1, 0, 'Beranda', './', '', 1, 1),
	(2, 0, 'Profil', 'pages/tentang-kami', '', 2, 1),
	(3, 0, 'Tutorial', 'category/', '', 3, 1),
	(19, 0, 'Shop', '#', '', 4, 1),
	(8, 0, 'Galeri', 'gallery', '', 5, 1),
	(9, 0, 'Kontak', 'contact', '', 6, 1),
	(10, 0, 'Home', './', '', 1, 2),
...
-- Dumping structure for table erekutoro.menu_group
...
-- Dumping data for table erekutoro.menu_group: 2 rows
...
-- Dumping structure for table erekutoro.oauth
...
-- Dumping data for table erekutoro.oauth: ~2 rows (approximately)
DELETE FROM `oauth`;
...
-- Dumping structure for table erekutoro.pages
...
-- Dumping data for table erekutoro.pages: ~2 rows (approximately)
DELETE FROM `pages`;
...
-- Dumping structure for table erekutoro.post
...
-- Dumping data for table erekutoro.post: ~8 rows (approximately)
DELETE FROM `post`;
...
-- Dumping structure for table erekutoro.setting
...
-- Dumping data for table erekutoro.setting: 1 rows
DELETE FROM `setting`;
...
INSERT INTO `setting` (`id_setting`, `website_name`, `website_url`, `website_email`, `meta_description`, `meta_keyword`, `favicon`, `timezone`, `website_maintenance`, `website_maintenance_tgl`, `website_cache`, `website_cache_time`, `member_register`) VALUES
	(1, 'Erekutoro', 'http://localhost/erekutoro', 'radan_stromer@yaho.co.id', 'Kumpulan Tutorial Arduino', 'arduino, erekutoro,rasbery,', 'favicon.png', 'Asia/Jakarta', 'N', '', 'N', '', 'Y');
/*!40000 ALTER TABLE `setting` ENABLE KEYS */;


-- Dumping structure for table erekutoro.subscribe
...
-- Dumping data for table erekutoro.subscribe: ~0 rows (approximately)
DELETE FROM `subscribe`;
/*!40000 ALTER TABLE `subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `subscribe` ENABLE KEYS */;


-- Dumping structure for table erekutoro.tag
...
-- Dumping data for table erekutoro.tag: 30 rows
DELETE FROM `tag`;
...
-- Dumping structure for table erekutoro.theme
...
-- Dumping data for table erekutoro.theme: ~2 rows (approximately)
DELETE FROM `theme`;
...
INSERT INTO `theme` (`id_theme`, `title`, `author`, `folder`, `active`) VALUES
	...
	(3, 'Erekutoro', 'Dadan', 'erekutoro', 'Y');
/*!40000 ALTER TABLE `theme` ENABLE KEYS */;


-- Dumping structure for table erekutoro.traffic
...
-- Dumping data for table erekutoro.traffic: 2 rows
DELETE FROM `traffic`;
/*!40000 ALTER TABLE `traffic` DISABLE KEYS */;
INSERT INTO `traffic` (`ip`, `tanggal`, `hits`, `online`) VALUES
	('127.0.0.1', '2015-12-19', 69, '1450543317'),
	('127.0.0.1', '2015-12-20', 119, '1450578417');
/*!40000 ALTER TABLE `traffic` ENABLE KEYS */;


-- Dumping structure for table erekutoro.users
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `testimonial` text COLLATE latin1_general_ci,
  `status_testimonial` enum('Y','N') COLLATE latin1_general_ci NOT NULL DEFAULT 'N',
  PRIMARY KEY (`username`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

-- Dumping data for table erekutoro.users: 2 rows
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id_user`, `username`, `password`, `nama_lengkap`, `email`, `no_telp`, `bio`, `userpicture`, `level`, `blokir`, `id_session`, `tgl_daftar`, `forget_key`, `locktype`, `testimonial`, `status_testimonial`) VALUES
	(1, 'admin', '0192023a7bbd73250516f069df18b500', 'Administrator', 'radan_stromer@yaho.co.id', '08xxxxxxxxxx', 'No matter how exciting or significant a person\'s life is, a poorly written biography will make it seem like a snore. On the other hand, a good biographer can draw insight from an ordinary life-because they recognize that even the most exciting life is an ordinary life! After all, a biography isn\'t supposed to be a collection of facts assembled in chronological order; it\'s the biographer\'s interpretation of how that life was different and important.', '', '1', 'N', 'hppk20sqtvo9p4no0erjbhcb92', '2015-12-19', NULL, '0', NULL, 'N'),
	(2, 'radan', 'd8b78f5e6dfd970d89657808a42f18c3', 'Dadan', 'dadan@info.com', '01039093029032', '', '2.jpg', '3', 'N', '3e5jar6grvuph0a4s8q40fiam3', '2015-12-19', NULL, '0', 'test testi 2222', 'Y');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;


-- Dumping structure for table erekutoro.user_level
...
-- Dumping data for table erekutoro.user_level: ~3 rows (approximately)
...
-- Dumping structure for table erekutoro.user_role
...
-- Dumping data for table erekutoro.user_role: ~42 rows (approximately)
